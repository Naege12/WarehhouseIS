...
public class WarehousesPanel extends javax.swing.JPanel {
    ...
    public WarehousesPanel() {
        ...
        loadData();
        ld = LocalDate.now();
        warehouseDateLabel.setText(ld.toString());
    }
    ...
    private void showEditWarehouseDialog(Warehouse warehouse) {
        ...
        JTextField txtName = new JTextField(warehouse.getName());
        JTextField txtAddress = new JTextField(warehouse.getAddress());
        ...
        btnSave.addActionListener(e -> {
            if (txtName.getText().trim().isEmpty()) {
                JOptionPane.showMessageDialog(dialog, "Введите название склада");
                return;
            }
            ...
            if (success) {
                dialog.dispose();
                loadData();
                JOptionPane.showMessageDialog(this, "Склад обновлён");
            } else {
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        ...
        if (selectedRow == -1) {
            JOptionPane.showMessageDialog(this, "Выберите склад для редактирования");
            return;
        }

        Long warehouseId = (Long) tblWarehouse.getValueAt(selectedRow, 0);
        Warehouse warehouse = warehouseDAO.getWarehouseById(warehouseId);

        if (warehouse == null) {
            JOptionPane.showMessageDialog(this, "Склад не найден");
            return;
        }
